...
- `pgregory.net/rapid` v1.3.0 API: use `rapid.SampledFrom([]rune{...})` for character ranges (there is no `RuneRange`); `rapid.IntRange`, `rapid.Int64Range`, `rapid.Float64Range`, `rapid.Bool`, `rapid.StringN`, `rapid.SliceOfN` for primitives.
